...
class RisksControllerTest < ActionController::TestCase
  ...
  test "should update risk" do
    patch :update, id: @risk, risk: { description: @risk.description, from_date: @risk.from_date, from_time: @risk.from_time, location_id: @risk.location_id, type_id: @risk.type_id }
    assert_redirected_to risk_path(assigns(:risk))
  end
